...
import projects.forms.ProjectCreationForm;
import projects.forms.ProjectUpdateForm;
...
public class ProjectManager {
	...
	public void createProject(ProjectCreationForm form) {
		Project p = new Project(form.getName(), form.getDescription(), null, 
								new Version(1, 0, 0), form.getStartingDate())
	}
