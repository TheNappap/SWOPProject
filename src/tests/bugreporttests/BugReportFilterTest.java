...
public class BugReportFilterTest {
	...
	public void setUp() throws Exception {
		...
		BugReport bugReport1 = new BugReport("This is a BugReport", "Typo, low priority", null, null, assignees1, null, new Issuer(null, null, null, "George"), null, null, null, null);
		BugReport bugReport2 = new BugReport("Urgent!!!!", "Please take a look at this BugReport!", null, null, assignees2, null, new Issuer(null, null, null, "Michael"), null, null, null, null);
		BugReport bugReport3 = new BugReport("CRITICAL ERROR", "BEEP BOOP", null, null, assignees3, null, new Issuer(null, null, null, "George"), null, null, null, null);
